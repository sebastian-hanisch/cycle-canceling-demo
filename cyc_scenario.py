...
def detour_cost():
    """Umweg: S->X (Kapazität 1, Kosten 0), X->T direkt (1, 9), X->A (1, 1), A->T (1, 1). Der Weg mit den wenigsten Kanten (S-X-T) kostet 9, der Umweg S-X-A-T nur 2. Edmonds-Karp nimmt den kurzen Weg;
    im Restgraphen entsteht der Kreis X->A->T->X (1 + 1 - 9 = -7) - Cycle-Canceling löscht ihn und kommt auf 2."""
    names = ["S", "T", "X", "A"]
    pos = [(50, 92), (50, 8), (50, 62), (82, 36)]
    arcs = [(0, 2, 1, 0), (2, 1, 1, 9), (2, 3, 1, 1), (3, 1, 1, 1)]
